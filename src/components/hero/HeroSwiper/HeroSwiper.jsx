        ...
        <div className="relative w-full h-full">
            <Swiper
                ...
                pagination={{
                    ...
                    renderBullet: function (_, className) {
                        return `<span class="${className} block w-1 h-1 bg-white mr-1 last:mr-0"></span>`;
                      },
                }}
                className="h-full"
            >
            ...
            <div className="absolute bottom-0 left-0 w-full xl:w-3/4 flex justify-end bg-black-light h-[199px] xl:rounded-tr-xl z-10 overflow-hidden">
                <div className="flex items-center justify-between w-2/3 pl-[70px] pr-[125px]">
                    <div className="flex">
                        <button id="prev" className="flex items-center justify-center w-[36px] h-[36px] mr-4 rounded-full border border-[#393939] hover:border-yellow [&_path]:hover:stroke-white transition"><ArrowIcon className="[&>path]:stroke-[#393939] transition rotate-180" /></button>
                        <button id="next" className="flex items-center justify-center w-[36px] h-[36px] ml-4 rounded-full border border-[#393939] hover:border-yellow [&_path]:hover:stroke-white transition"><ArrowIcon className="[&>path]:stroke-[#393939] transition" /></button>
                    </div>
                ...
                <div className="flex flex-col justify-center w-2/5 xl:w-1/3 pl-[4%] pr-[1%] 2xl:pl-[8%] 2xl:pr-[2%] bg-black-dark h-full self-end">
                    ...
                    <div className="flex items-center mt-5">
                        <div className="text-xl text-white font-bold">
                            <p>
                                <span className="text-sm text-[#7B8487]">
                                    +38
                                </span>{" "}
                                (093) 833-29-99
                            </p>
